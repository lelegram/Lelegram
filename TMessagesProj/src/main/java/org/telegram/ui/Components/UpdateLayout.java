...
import com.fylnx.lelegram.helpers.ApkInstaller;
...
public class UpdateLayout extends IUpdateLayout {
    ...
    public void createUpdateUI(int currentAccount) {
        ...
        updateTextView.setText(LocaleController.getString(R.string.UpdateLelegram), false);
        ...
        if (SharedConfig.isAppUpdateAvailable()) {
            ...
            if (path.exists()) {
                ...
                if (FileLoader.getInstance(currentAccount).isLoadingFile(fileName)) {
                    ...
                    setUpdateText(LocaleController.getString(R.string.UpdateLelegram), animated);
                    showSize = true;
                }
            }
