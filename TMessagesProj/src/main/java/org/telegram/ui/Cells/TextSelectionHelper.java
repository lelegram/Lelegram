    ...
    private ActionMode.Callback createActionCallback() {
        final ActionMode.Callback callback = new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                ...
                menu.add(Menu.NONE, android.R.id.shareText, 6, LocaleController.getString(R.string.ShareFile));
                return true;
            }
            ...
            private void updateTranslateButton(Menu menu) {
                ...
                if (onTranslateListener != null) {
                    languageAllowed = !LanguageDetector.hasSupport() || translateFromLanguage != null && !RestrictedLanguagesSelectActivity.getRestrictedLanguages().contains(translateFromLanguage);
                } else {
                    languageAllowed = !LanguageDetector.hasSupport() || translateFromLanguage != null && !Translator.isLanguageRestricted(translateFromLanguage);
                }
                translateItem.setVisible(canCopy() && languageAllowed);
            }
            ...
            public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                ...
                if (itemId == android.R.id.copy) {
                    ...
                    if (onTranslateListener != null) {
                        ...
                        onTranslateListener.run(str, translateFromLanguage, translateToLanguage, TextSelectionHelper.this::showActions);
                        hideActions();
                    } else {
