...
public class DatacenterPopupWrapper {
    ...
    public DatacenterPopupWrapper(BaseFragment fragment, PopupSwipeBackLayout swipeBackLayout, Theme.ResourcesProvider resourcesProvider) {
        ...
        textView.setText(BaseLeleSettingsActivity.getSpannedString(R.string.DatacenterStatusAbout, "https://core.telegram.org/api/datacenter"));
    ...
    private void checkDatacenter(ActionBarMenuSubItem item, boolean force, Theme.ResourcesProvider resourcesProvider) {
        ...
        datacenterInfo.pingId = ConnectionsManager.getInstance(UserConfig.selectedAccount).checkProxy("ping.lele", datacenterInfo.id, null, null, null, time -> AndroidUtilities.runOnUIThread(() -> {
