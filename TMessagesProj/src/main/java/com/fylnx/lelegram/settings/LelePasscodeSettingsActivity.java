...
public class LelePasscodeSettingsActivity extends BaseLeleSettingsActivity {
    ...
    protected void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        var link = String.format(Locale.ENGLISH, "https://t.me/lelesettings/%s", PasscodeHelper.getSettingsKey());
        ...
        stringBuilder.setSpan(new URLSpanNoUnderline(null) {
            ...
            public void onClick(@NonNull View view) {
                ...
                BulletinFactory.of(LelePasscodeSettingsActivity.this).createCopyLinkBulletin().show();
            }
    ...
    protected String getActionBarTitle() {
        return LocaleController.getString(R.string.PasscodeLele);
    }
