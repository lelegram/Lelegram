...
public class LeleLanguagesSelectActivity extends BaseLeleSettingsActivity {
    ...
    private final ArrayList<LeleLanguagesSelectActivity.LocaleInfo> allLanguages = new ArrayList<>();
    private final ArrayList<LeleLanguagesSelectActivity.LocaleInfo> sortedLanguages = new ArrayList<>();
    private final ArrayList<LeleLanguagesSelectActivity.LocaleInfo> searchResult = new ArrayList<>();
    ...
    public LeleLanguagesSelectActivity(int type) {
    ...
    private void search(String text) {
        ...
        Utilities.searchQueue.postRunnable(searchRunnable = () -> {
            var results = new ArrayList<LeleLanguagesSelectActivity.LocaleInfo>();
        ...
        Collections.sort(sortedLanguages, (o1, o2) -> {
            if (currentType == TYPE_TARGET) {
                if (o1.langCode.equals("app")) {
                    ...
                    return 1;
                } else if (LeleConfig.translationTarget.equals(o1.langCode)) {
                    return -1;
                } else if (LeleConfig.translationTarget.equals(o2.langCode)) {
                    return 1;
                }
    ...
    protected void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        for (var locale : (searchWas ? searchResult : sortedLanguages)) {
            ...
            item.checked = currentType == TYPE_RESTRICTED ? restrictedLanguages.contains(locale.langCode) : LeleConfig.translationTarget.equals(locale.langCode);
            items.add(item);
        }
        items.add(UItem.asShadow(null));
    }
    ...
    protected void onItemClick(UItem item, View view, int position, float x, float y) {
        ...
        if (localeInfo != null) {
            if (currentType == TYPE_RESTRICTED) {
                ...
                LeleConfig.setTranslationTarget(localeInfo.langCode);
                finishFragment();
            }
        }
    }
