...
public abstract class BaseLeleSettingsActivity extends BaseFragment {
    ...
    public BaseLeleSettingsActivity() {
        this(null);
    }

    public BaseLeleSettingsActivity(Bundle args) {
        super(args);
    ...
    public View createView(Context context) {
        ...
        listView = new UniversalRecyclerView(this, this::fillItems, this::onItemClick, (item, view, position, x, y) -> {
                ...
                ItemOptions.makeOptions(this, view)
                        ...
                        .add(R.drawable.msg_copy, LocaleController.getString(R.string.CopyLink), () -> {
                            if ("copyReportId".equals(slug)) {
                                AndroidUtilities.addToClipboard(String.format(Locale.getDefault(), "https://%s/lelesettings/%s", getMessagesController().linkPrefix, "reportId"));
                            } else if ("checkUpdate".equals(slug)) {
                                AndroidUtilities.addToClipboard(String.format(Locale.getDefault(), "https://%s/lelesettings/%s", getMessagesController().linkPrefix, "update"));
                            } else {
                                AndroidUtilities.addToClipboard(String.format(Locale.getDefault(), "https://%s/lelesettings/%s?r=%s", getMessagesController().linkPrefix, key, slug));
                            }
            ...
            public Integer getSelectorColor(int position) {
                return BaseLeleSettingsActivity.this.getSelectorColor(position);
            }
        };
